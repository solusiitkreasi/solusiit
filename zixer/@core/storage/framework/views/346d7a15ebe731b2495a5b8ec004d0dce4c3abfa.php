                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.team.member')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control max-height-150" cols="30" rows="10" placeholder="<?php echo e(__('Description')); ?>"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="icon_one"><?php echo e(__('Social Profile One')); ?></label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_one"  name="icon_one" placeholder="<?php echo e(__('Social Profile One')); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="icon_two"><?php echo e(__('Social Profile Two')); ?></label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_two"  name="icon_two" placeholder="<?php echo e(__('Social Profile Two')); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="icon_three"><?php echo e(__('Social Profile Three')); ?></label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_three"  name="icon_three" placeholder="<?php echo e(__('Social Profile Three')); ?>">
                            </div>
                            <div class="form-group">
                ...
                <form action="#" id="team_member_edit_modal_form"  method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="edit_description" class="form-control max-height-150" cols="30" rows="10" placeholder="<?php echo e(__('Description')); ?>"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="edit_icon_one"><?php echo e(__('Social Profile One')); ?></label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_one"  name="icon_one" placeholder="<?php echo e(__('Social Profile One')); ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edit_icon_two"><?php echo e(__('Social Profile Two')); ?></label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_two"  name="icon_two" placeholder="<?php echo e(__('Social Profile Two')); ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edit_icon_three"><?php echo e(__('Social Profile Three')); ?></label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_three"  name="icon_three" placeholder="<?php echo e(__('Social Profile Three')); ?>">
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/zixer/@core/resources/views/backend/pages/team-member.blade.php ENDPATH**/ ?>