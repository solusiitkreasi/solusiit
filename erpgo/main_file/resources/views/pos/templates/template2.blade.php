...
{{--                                </div>--}}
                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('POS')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table">
                                        <tbody data-v-37eeda86="">
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Number')}}:</td>
                                            <td data-v-37eeda86="" class="text-right">{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('POS Date')}}:</td>
                                            <td data-v-37eeda86=""
                                                class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
