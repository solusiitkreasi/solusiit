                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.site.identity')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted"><?php echo e(__('allowed image format: jpg,jpeg,png. max image size 2MB')); ?></small>
                            </div>
                            <div class="img-wrapper" style="margin: 20px;">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/zixer/@core/resources/views/backend/general-settings/site-identity.blade.php ENDPATH**/ ?>