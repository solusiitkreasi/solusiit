                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('Purchase')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{Utility::posNumberFormat($settings,$pos->purchase_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{Utility::dateFormat($settings,$pos->purchase_date)}}</p>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="row">
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('POS Date')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
                                             @if(!empty($customFields) && count($pos->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr data-v-37eeda86="">
                                                        <td  data-v-37eeda86="" class="tu">{{$field->name}} :</td>
                                                        <td data-v-37eeda86="" class="text-right"> {{!empty($pos->customField)?$pos->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
...
{{--                                            {!! DNS2D::getBarcodeHTML(route('purchase.link.copy',\Crypt::encrypt($pos->purchase_id)), "QRCODE",2,2) !!}--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
                                <div data-v-7d9d14b5="" class="break-50"></div>
