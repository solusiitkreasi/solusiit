                                    ...
                                    <table class="table table-default">
                                        ...
                                        @foreach($work as $data)
                                            <tr>
                                                ...
                                                <td>{{$data->location}}</td>
                                                <td>{!! Str::words($data->description,20) !!}</td>
                                                <td>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.work.update')}}" id="works_edit_modal_form" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_location">{{__('Location')}}</label>
                            <input type="text" class="form-control"  id="edit_location"  name="location" placeholder="{{__('Location')}}">
                        </div>
                        <div class="form-group">
