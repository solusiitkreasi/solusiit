                            ...
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <h1 data-v-136bf9b5="" class="fancy-title mb5" style="color: {{$color}};">{{__('POS')}}</h1>
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('POS Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
