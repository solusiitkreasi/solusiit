...
<form class="form">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required">API - @lang('lang.secret_key')*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                title="@lang('lang.gateway_general_info')" data-placement="top"><i
    ...
    <div class="form-group row">
        <label
            class="col-sm-12 text-left control-label col-form-label required">@lang('lang.currency')*</label>
        <div class="col-sm-12">
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings2_tap_currency_code"
                name="settings2_tap_currency_code" data-preselected="{{ $settings->settings2_tap_currency_code ?? 'KWD'}}">
                <option></option>
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 text-left control-label col-form-label required">@lang('lang.language')*</label>
            <div class="col-sm-12">
