                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.team.member')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control max-height-150" cols="30" rows="10" placeholder="{{__('Description')}}"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="icon_one">{{__('Social Profile One')}}</label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_one"  name="icon_one" placeholder="{{__('Social Profile One')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="icon_two">{{__('Social Profile Two')}}</label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_two"  name="icon_two" placeholder="{{__('Social Profile Two')}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="icon_three">{{__('Social Profile Three')}}</label>
                                <input type="text" class="form-control fa-icon-picker"  id="icon_three"  name="icon_three" placeholder="{{__('Social Profile Three')}}">
                            </div>
                            <div class="form-group">
                ...
                <form action="#" id="team_member_edit_modal_form"  method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="edit_description" class="form-control max-height-150" cols="30" rows="10" placeholder="{{__('Description')}}"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="edit_icon_one">{{__('Social Profile One')}}</label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_one"  name="icon_one" placeholder="{{__('Social Profile One')}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edit_icon_two">{{__('Social Profile Two')}}</label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_two"  name="icon_two" placeholder="{{__('Social Profile Two')}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edit_icon_three">{{__('Social Profile Three')}}</label>
                            <input type="text" class="form-control fa-icon-picker"  id="edit_icon_three"  name="icon_three" placeholder="{{__('Social Profile Three')}}">
                        </div>
                        <div class="form-group">
