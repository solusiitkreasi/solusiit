                        ...
                        <form action="<?php echo e(route('admin.homeone.counterup')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="img-preview">
                                <?php if(file_exists('assets/uploads/'.get_static_option('home_02_counterup_bg_image'))): ?>
                                    <img style="max-width: 200px" src="<?php echo e(asset('assets/uploads/'.get_static_option('home_02_counterup_bg_image'))); ?>" alt="">
                                <?php endif; ?>
                            </div>
                            <div class="form-group">
                                <label for="home_02_counterup_bg_image"><?php echo e(__('Background Image')); ?> </label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/zixer/@core/resources/views/backend/pages/home/home-01/counterup.blade.php ENDPATH**/ ?>