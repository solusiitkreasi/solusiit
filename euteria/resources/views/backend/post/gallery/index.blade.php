...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <x-data-tables-server-side :tableHeader="['No','Gambar','Nama','Deskripsi','Action']" id="data-table"></x-data-tables-server-side>
        </div>
    </div>
</div>    
@endsection
    ...
    $(document).ready(function(e){
        ...
        const $table = $('#data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'description', name: 'description',width:"5%", orderable : false},
