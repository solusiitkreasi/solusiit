                        ...
                        <div data-v-4b3dcb8a="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2"><h1 data-v-4b3dcb8a="" class="fancy-title mb5">{{__('POS')}}</h1></div>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('POS Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
