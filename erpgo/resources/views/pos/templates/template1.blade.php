                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title ">{{__('POS')}}</div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('POS Date')}}:</td>
                                                <td>{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
                                                ...
                                                @if(isset($pos->itemData) && count($pos->itemData) > 0)
                                                    @foreach($pos->itemData as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                            <div class="d-table-td w-4"><pre data-v-f2a183a6="">{{$item->name}}</pre></div>
                                                            <div class="d-table-td w-3"><pre data-v-f2a183a6="">{{$item->quantity}}</pre></div>
                                                            <div class="d-table-td w-4 "><pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$item->price)}}</pre></div>
