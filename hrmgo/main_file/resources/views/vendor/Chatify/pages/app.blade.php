        ...
        <div class="card-body">
            <div class="messenger rounded min-h-750 overflow-hidden">
                ...
                <div class="messenger-listView">
                    ...
                    {{-- Lists [Users/Group] --}}
                    {{-- ---------------- [ User Tab ] ---------------- --}}
                    <div class="@if($route == 'user') show1 @endif messenger-tab app-scroll" data-view="users">
                        ...
                        <nav class="d-flex a;align-items-center justify-content-between">
                            ...
                            <div style="display: flex;">
                                    ...
                                    @if(!empty(Auth::user()->avatar))
                                        <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ \App\Models\Utility::get_file('uploads/avatar/'.Auth::user()->avatar) }}');"></div>
                                    @else
                                        <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ \App\Models\Utility::get_file('uploads/avatar/avatar.png') }}');"></div>
                                    @endif
