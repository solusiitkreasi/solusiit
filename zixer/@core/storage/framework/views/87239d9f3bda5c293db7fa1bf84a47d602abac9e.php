                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.testimonial')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="info-text"><?php echo e(__('260x300 px image recommended')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\test\sik\evkatama\zixer\@core\resources\views/backend/pages/testimonial.blade.php ENDPATH**/ ?>