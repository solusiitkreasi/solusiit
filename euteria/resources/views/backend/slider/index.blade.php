...
<div class="col-lg-12">    
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{route('admin.slider.create')}}" class="btn btn-primary btn-sm float-right">
                <i class="fa fa-plus"></i>
            </a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <x-data-tables-server-side :tableHeader="['No','Gambar','Order','Action']" id="data-table"></x-data-tables-server-side>
            </div>                
        </div>
    </div>
</div>    
    ...
    $(document).ready(function(e){
        ...
        const $table = $('#data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'order', name: 'order',width:"5%", orderable : false},
        ...
        $('#data-table').on('click','a.order-slider',function(e) {
            e.preventDefault();        
