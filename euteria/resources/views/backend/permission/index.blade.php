...
<div class="col-lg-12">    
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{route('admin.permission.create')}}" class="btn btn-primary btn-sm float-right">
                <i class="fa fa-plus"></i>
            </a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <x-data-tables-server-side :tableHeader="['No','Nama','Tampilan Nama','Action']" id="data-table"></x-data-tables-server-side>
            </div>                
        </div>
    </div>
</div>    
...
<script>
    $(document).ready(function(e){
        ...
        const $table = $('#data-table').DataTable({
            ...
            ajax: {
                url : '{!! route("admin.permission.source") !!}',
                dataSrc: 'data'
            },
            columns: [
                ...
                {data: 'display_name', name: 'display_name',width:"5%", orderable : false},
