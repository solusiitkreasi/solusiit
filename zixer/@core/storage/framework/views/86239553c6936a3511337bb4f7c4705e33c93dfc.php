                                    ...
                                    <table class="table table-default">
                                        ...
                                        <?php $__currentLoopData = $work; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo Str::words($data->description,20); ?></td>
                                                <td>
                                               ...
                                               <br>
                                                ...
                                                ">
                                                    ...
                                                    <a href="#"
                                                       ...
                                                       data-location="<?php echo e($data->location); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.work')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="location"  name="location" placeholder="<?php echo e(__('Location')); ?>">
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.work.update')); ?>" id="works_edit_modal_form" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_location"><?php echo e(__('Location')); ?></label>
                            <input type="text" class="form-control"  id="edit_location"  name="location" placeholder="<?php echo e(__('Location')); ?>">
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/zixer/@core/resources/views/backend/pages/works/index.blade.php ENDPATH**/ ?>