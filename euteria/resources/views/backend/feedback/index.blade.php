...
<div class="col-lg-12">    
    <div class="card">
        <div class="card-header">
            ...
            {{-- <a href="{{route('admin.feedback.create')}}" class="btn btn-primary btn-sm float-right">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <x-data-tables-server-side :tableHeader="['No', 'Name', 'Email', 'Company Name', 'Feedback Rating','Status','Action']" id="data-table"></x-data-tables-server-side>
            </div>                
        </div>
    </div>
</div>    
...
<script>
    $(document).ready(function(e){
        ...
        const $table = $('#data-table').DataTable({
            ...
            ajax: {
                url : '{!! route("admin.feedback.source") !!}',
                dataSrc: 'data'
            },
            columns: [
                ...
                {data: 'name', name: 'name',width:"5%", orderable : false, searchable: true},
                {data: 'company', name: 'company',width:"5%", orderable : false, searchable: true},
                {data: 'email', name: 'email',width:"5%", orderable : false, searchable: true},
                {data: 'rate', name: 'rate',width:"5%", orderable : false, searchable: false},
