...
if ($("#data_picker3").length) {
    $( "#data_picker3" ).each(function( index ) {
        (function () {
            const d_week = new Datepicker(document.querySelector('#data_picker3'), {
                buttonClass: 'btn',
                format: 'yyyy-mm-dd',
            });
        })();
...
if ($("#data_picker4").length) {
    $( "#data_picker4" ).each(function( index ) {
        (function () {
            const d_week = new Datepicker(document.querySelector('#data_picker4'), {
                buttonClass: 'btn',
                format: 'yyyy-mm-dd',
            });
        })();
