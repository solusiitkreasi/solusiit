                            ...
                            <div data-v-e95a8a8c="" class="d-inner">
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-2">
                                        <h1 data-v-e95a8a8c="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('POS')}}</h1></div>
                                    ...
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            ...
                                            <tr data-v-e95a8a8c="">
                                                ...
                                                <td data-v-e95a8a8c="" class="text-right">{{Utility::purchaseNumberFormat($settings,$pos->pos_id)}}</td>
                                            </tr>
                                            <tr data-v-e95a8a8c="">
                                                <td data-v-e95a8a8c="" class="tu fwb" style="color: {{$color}};">{{__('POS Date')}}:</td>
                                                <td data-v-e95a8a8c="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
