    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <x-data-tables-server-side :tableHeader="['No','Image','Nama','Parent','Action']" id="data-table"></x-data-tables-server-side>
            </div>                
        </div>
    </div>
</div>    
...
<script>
    $(document).ready(function(e){
        ...
        const $table = $('#data-table').DataTable({
            ...
            ajax: {
                url : '{!! route("admin.category.source") !!}',
                dataSrc: 'data'
            },
            columns: [
                ...
                {data: 'parent', name: 'parent',width:"5%", orderable : false},
