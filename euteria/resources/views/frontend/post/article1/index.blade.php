    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="news-post standard-post2">
                {{-- <div class="post-gallery" style="background-image: url('{{$row->first_images}}');background-size:cover;width:100%;height:250px; background-repeat: no-repeat;background-position: center; "> --}}
                <div class="post-gallery">
                    <img src="{{asset(imageFly($row->first_images,[330,260]))}}" alt="">
