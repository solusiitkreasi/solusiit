                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('Purchase')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('POS Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                            </tr>
