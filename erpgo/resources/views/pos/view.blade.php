                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <small>
                                ...
                                @if($pos->status == 0)
                                    <span class="badge bg-secondary p-2 px-3 rounded">{{ __(\App\Models\Purchase::$statues[$pos->status]) }}</span>
                                @elseif($pos->status == 1)
                                    <span class="badge bg-warning p-2 px-3 rounded">{{ __(\App\Models\Purchase::$statues[$pos->status]) }}</span>
                                @elseif($pos->status == 2)
                                    <span class="badge bg-danger p-2 px-3 rounded">{{ __(\App\Models\Purchase::$statues[$pos->status]) }}</span>
                                @elseif($pos->status == 3)
                                    <span class="badge bg-info p-2 px-3 rounded">{{ __(\App\Models\Purchase::$statues[$pos->status]) }}</span>
                                @elseif($pos->status == 4)
                                    <span class="badge bg-success p-2 px-3 rounded">{{ __(\App\Models\Purchase::$statues[$pos->status]) }}</span>
                                @endif
                            </small>
                        </div>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($iteams as $key =>$iteam)
                                        ...
                                        <tr>
                                            ...
                                            <td >{{\Auth::user()->priceFormat(($iteam->price*$iteam->quantity))}}</td>
                                        </tr>
                                    @endforeach
