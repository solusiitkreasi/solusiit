                        ...
                        <div data-v-363339a0="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-2"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('POS')}}</h1>
                                        ...
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-right">{{Utility::posNumberFormat($settings,$pos->pos_id)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('POS Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($settings,$pos->pos_date)}}</td>
                                                </tr>
